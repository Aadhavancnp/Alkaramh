...
import React, { useContext, useState } from 'react'; // Ensure React is imported
import {
    ActivityIndicator,
    Modal,
    StyleSheet,
...
const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('https://alkarmah-backend.onrender.com/api/auth/change-password', {
        method: 'POST',
        headers: {
